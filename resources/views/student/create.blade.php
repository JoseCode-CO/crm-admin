                        ...
                        <form action="{{ route('students.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('first_name') is-invalid @enderror"
                                    id="nombre" name="first_name" value="{{ old('first_name') }}">
                                @error('first_name')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('last_name') is-invalid @enderror"
                                    id="apellidos" name="last_name" value="{{ old('last_name') }}">
                                @error('last_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="escuela" name="schools_id">
                                    <option value="">Seleccione una escuela</option> <!-- Opción por defecto -->
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control @error('date_of_birth') is-invalid @enderror"
                                    id="fecha-nacimiento" name="date_of_birth" value="{{ old('date_of_birth') }}">
                                @error('date_of_birth')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
